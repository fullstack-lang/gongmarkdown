...
import (
	...
	"github.com/fullstack-lang/gongmarkdown"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongmarkdown.NgDistNg, "ng-github.com-fullstack-lang-gongmarkdown/dist/ng-github.com-fullstack-lang-gongmarkdown/browser")))
