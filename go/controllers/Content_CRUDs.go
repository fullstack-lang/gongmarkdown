...
func (controller *Controller) GetContents(c *gin.Context) {
	...
	if backRepo == nil {
		message := "GET Stack github.com/fullstack-lang/gongmarkdown/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) PostContent(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/fullstack-lang/gongmarkdown/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) GetContent(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Stack github.com/fullstack-lang/gongmarkdown/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) UpdateContent(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/fullstack-lang/gongmarkdown/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) DeleteContent(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/fullstack-lang/gongmarkdown/go, Unkown stack: \"" + stackPath + "\"\n"
