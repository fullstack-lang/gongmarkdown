...
type ParagraphDB struct {
	...
	// Declation for basic field paragraphDB.Name {{BasicKind}} (to be completed)
	Name_Data sql.NullString

	// Declation for basic field paragraphDB.Content {{BasicKind}} (to be completed)
...
// BackRepoParagraph.Init set up the BackRepo of the Paragraph
func (backRepoParagraph *BackRepoParagraphStruct) Init(db *gorm.DB) (Error error) {

	if backRepoParagraph.Map_ParagraphDBID_ParagraphPtr != nil {
		err := errors.New("In Init, backRepoParagraph.Map_ParagraphDBID_ParagraphPtr should be nil")
		return err
	}

	if backRepoParagraph.Map_ParagraphDBID_ParagraphDB != nil {
		err := errors.New("In Init, backRepoParagraph.Map_ParagraphDBID_ParagraphDB should be nil")
		return err
	}

	if backRepoParagraph.Map_ParagraphPtr_ParagraphDBID != nil {
		err := errors.New("In Init, backRepoParagraph.Map_ParagraphPtr_ParagraphDBID should be nil")
		return err
	}

	tmp := make(map[uint]*models.Paragraph, 0)
	backRepoParagraph.Map_ParagraphDBID_ParagraphPtr = &tmp

	tmpDB := make(map[uint]*ParagraphDB, 0)
	backRepoParagraph.Map_ParagraphDBID_ParagraphDB = &tmpDB

	tmpID := make(map[*models.Paragraph]uint, 0)
	backRepoParagraph.Map_ParagraphPtr_ParagraphDBID = &tmpID

	backRepoParagraph.db = db
	return
}
...
func (backRepoParagraph *BackRepoParagraphStruct) CheckoutPhaseOne() (Error error) {
	...
	paragraphInstancesToBeRemovedFromTheStage := make(map[*models.Paragraph]struct{})
	for key, value := range models.Stage.Paragraphs {
