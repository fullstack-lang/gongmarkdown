...
export class ContentService {
  ...
  constructor(
    ...
    this.contentsUrl = origin + '/api/github.com/fullstack-lang/gongmarkdown/go/v1/contents';
  }

  /** GET contents from the server */
  // gets is more robust to refactoring
  gets(GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI[]> {
    return this.getContents(GONG__StackPath, frontRepo)
  }
  getContents(GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI[]> {
  ...
  get(id: number, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
    return this.getContent(id, GONG__StackPath, frontRepo)
  }
  getContent(id: number, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
  ...
  postFront(content: Content, GONG__StackPath: string): Observable<ContentAPI> {
  ...
  post(contentdb: ContentAPI, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
    return this.postContent(contentdb, GONG__StackPath, frontRepo)
  }
  postContent(contentdb: ContentAPI, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
  ...
  delete(contentdb: ContentAPI | number, GONG__StackPath: string): Observable<ContentAPI> {
    return this.deleteContent(contentdb, GONG__StackPath)
  }
  deleteContent(contentdb: ContentAPI | number, GONG__StackPath: string): Observable<ContentAPI> {
  ...
  updateFront(content: Content, GONG__StackPath: string): Observable<ContentAPI> {
    let contentAPI = new ContentAPI
    CopyContentToContentAPI(content, contentAPI)
    const id = typeof contentAPI === 'number' ? contentAPI : contentAPI.ID
    const url = `${this.contentsUrl}/${id}`;
  ...
  update(contentdb: ContentAPI, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
    return this.updateContent(contentdb, GONG__StackPath, frontRepo)
  }
  updateContent(contentdb: ContentAPI, GONG__StackPath: string, frontRepo: FrontRepo): Observable<ContentAPI> {
    const id = typeof contentdb === 'number' ? contentdb : contentdb.ID;
    const url = `${this.contentsUrl}/${id}`;
